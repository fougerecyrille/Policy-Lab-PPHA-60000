...
ZIP_PATH = r"" # Edit the file path so that it points to the .zip file where all the different reports from the various California counties are stored; the word clouds and 
...
def build_stopwords() -> set:
    ...
    org_terms = {
        ...
        "vendor", "vendors", "vchsa", "ychhsd", "welfare", "wex", "ssd", "acssa", "tws", "lcdss", "dhhs", "hhs", "hss", "cwes", "ecc"
    }   

    # 3.3 Geographic terms (generic + county tokens)
    geo_terms = {
        "angeles", "area", "areas", "bay", "cal", "california", "central", "city", "cities",
        ...
        "joaquin", "kern", "kings", "king", "lake", "lassen", "la", "los", "luis", "marin", "mariposa",
    ...
    report_filler = {
        ...
        "section", "social", "high", "individual", "need", "etc", "rate", "would"
        ,"first","second","third", "include", "provide", "offer", "goal", "policy", "memo", "describe",
        "outcome", "lead", "quarter", "jun", "jul", "oc", "nov", "dec"
    }
